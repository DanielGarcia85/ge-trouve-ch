...
| Composant | Choix | Justification (à détailler dans le mémoire) |
|---|---|---|
| **Langage** | Python 3.11+ | Standard du domaine NLP/ML |
| **Framework RAG** | LangChain ou LlamaIndex *(à trancher)* | Comparaison documentée au Chapitre 2 |
| **LLM** | Mistral 7B *(servi via Ollama)* | Excellent en français, open-source, déployable localement |
| **Embeddings** | Modèle multilingue *(à trancher)* | Optimisé français, voir Chapitre 4 |
| **Base vectorielle** | ChromaDB | Légère, simple, adaptée à un projet de cette envergure |
| **Évaluation** | RAGAS | Standard du domaine, voir Chapitre 6 |
| **Interface** | Streamlit *(à confirmer)* | Rapide à mettre en place pour un prototype |
| **Déploiement** | VPS Linux Infomaniak | Hébergement suisse, souveraineté des données |
